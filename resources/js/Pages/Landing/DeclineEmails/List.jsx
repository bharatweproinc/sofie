...
const Headers = [
    "Mentor ID", "Mentee ID","Decline Type", "Decline Reason Mentioned", "Send Email", "Delete"
]
function List({list=[]}) {
    console.log('li',list);
  return (
                                      ...
                                      <TableBody>
                                          {list.mails.map((row) => (
                                              ...
                                              >
                                                  ...
                                                  <TableCell align="left">{row.decline_type}</TableCell>
                                                  <TableCell align="left">{row.decline_message}</TableCell>
                                                  <TableCell>
                                                        <a href={route("admin.sendCustomDeclineMail",row.id)} target="_blank">
                                                            <CheckIcon/>
                                                        </a>
                                                    </TableCell>
                                                    <TableCell>
                                                        <a href={route("admin.deleteCustomDeclineMail",row.id)} target="_blank">
                                                            <DeleteIcon/>
                                                        </a>
                                                    </TableCell>
                                              </TableRow>
