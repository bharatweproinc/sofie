    ...
    return (
        <Landing auth={user}>
            <Typography sx={{ height: {xs : '65px', sm : '0px'} }}></Typography>
             <Box p={3}>
                <Box p={3}>
                    <Typography fontWeight={700} fontSize="28px" textAlign="left" color={'#223049'}>Partially Matched SMEs and Mentors</Typography>
                </Box>
                <Box>
                {
                    list.length > 0 ? 
                    ...
                    </Grid> : <NoDataFound message="No Partially Matched SMEs and Mentors available" />
                    }
                </Box>
            </Box>
         </Landing>
